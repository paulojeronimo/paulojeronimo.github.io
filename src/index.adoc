...
****
I have experience in *{uri-pj-sitemap}/#tags[many technologies^]* and
...
I work as a *{DevOps}* guy because I like automating tasks in private or
public {uri-cloud-platforms}[cloud platforms^] or data centers.
